<?php get_header(); ?>
<?php 
$disputo_author_page_layout = esc_attr(get_theme_mod('disputo_author_page_layout', 'twocolumnssidebar'));
...
<div id="header-wrapper">
    ...
    <div class="disputo-page-title <?php if($disputo_no_boxed) { echo 'noboxed-title'; } ?>">
        <div class="container">
            <p class="author-subtitle"><?php echo esc_html__( 'All posts by', 'disputo' ); ?></p>
...
<main class="disputo-main-container">
    <div class="container">
    <div id="disputo-main-inner" class="<?php if (!get_the_author()) { ?>nomargin<?php } ?> <?php if($disputo_no_boxed) { echo 'nomargin noboxed'; } ?>">
        <?php if ($disputo_author_page_layout == 'twocolumns') { ?>
            ...
            <?php endif; ?> 
        <div class="clearfix"></div> 
        <?php } else if ($disputo_author_page_layout == 'threecolumns') { ?>
            <div class="disputo-masonry-grid">
            ...
            <?php if ( (get_next_posts_link()) || (get_previous_posts_link())) : ?>
                ...
                <div class="clearfix"></div>    
            <?php endif; ?>
        <?php } else if ($disputo_author_page_layout == 'fourcolumns') { ?>
        <div class="disputo-masonry-grid">
            ...
            <?php if ( (get_next_posts_link()) || (get_previous_posts_link())) : ?>
                ...
                <div class="clearfix"></div>    
            <?php endif; ?>
        <?php } else if ($disputo_author_page_layout == 'onecolumn') { ?> 
