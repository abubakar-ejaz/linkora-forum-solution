...
class Admin
{
    ...
    public function checkDb()
    {
        ...
        if ( !$wpdb->query("DESCRIBE {$m->wpdb_prefix}{$m->table}") ) {
            $this->feedback(
                __('<strong>bbPress Messages error</strong>: database error, the main database table was not inserted correctly. If you have just updated the plugin, please deactivate it and activate it once again, otherwise, please consult the support forums for help.', 'disputo'),
                false
            );
        }
    }
