...
// How to remove voting buttons from topic page
...
function bbp_voting_buttons($post_obj = false) {
    ...
    if(!empty($post)) {
        ...
        if($current_action === 'bbp_voting_cpt') {
            ...
            switch($this_post_type) {
                case $topic_post_type:
                    ...
                    $disable_forum_index_buttons = is_singular('topic') ? false : apply_filters('bbp_voting_disable_forum_index_buttons', false);
                break;
                case $reply_post_type:
                    ...
                    $disable_forum_index_buttons = false;
                break;
            }
        ...
        if(!empty($post_setting)) {
            ...
            // Use broad disable settings
            if($disable_forum_index_buttons === true) return;
        }
