...
function bbp_voting_settings_form($tab) {
    if($tab === null) { ?>
        ...
        'You can override this at the forum level');
        bbp_voting_field('bbp_voting_disable_forum_index_buttons', 
        'Disable Voting on Forum Index Page', 
        'Remove scores and voting buttons from the forum page', 
        'Voting on topics can still happen on the single topic pages.');
